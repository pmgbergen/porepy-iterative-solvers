...
def test_dofs_are_sorted(sample_linear_system: BlockLinearSystem):
    assert not sample_linear_system.dofs_are_sorted
    assert sample_linear_system[:].dofs_are_sorted
    assert not sample_linear_system[[2, 1]].dofs_are_sorted
    assert sample_linear_system[[1, 2]].dofs_are_sorted
    assert sample_linear_system[[1]].dofs_are_sorted
