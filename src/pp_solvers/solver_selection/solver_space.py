...
class _DecisionNode:
    ...
    def _str(self, prefix: str = "") -> str:
        """A recursive method that should be called from `__str__`. This traverses the
        tree and appends its children representation to the prefix.
