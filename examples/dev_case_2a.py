...
#             super().__init__(groups, "direct_solver")
...
#     return LinearSolverConfiguration(
#         transformations=[
#             SchurComplementReduction(primary_groups=primary_groups),
#             ScaleReferenceVariablesRightPreconditioner(
#                 {
#                     # "pressure": 22064000.0,
#                     "pressure": 10e6,
...
#             ),
#         ],
#         solver=DirectSolver(primary_groups),
#         groups=secondary_groups + primary_groups,
#     )
